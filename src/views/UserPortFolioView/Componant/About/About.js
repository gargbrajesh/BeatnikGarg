...
import { Typography, Grid, makeStyles, Button,Modal,Backdrop,Fade } from "@material-ui/core";
    ...
    fetch(
      ...
      .then((responseJson) => {
        ...
        if (responseJson.valid == false) {
          ...
          setLoading(false);
          setPortfolioMessage(responseJson.result.message);
     ...
     <Modal
      ...
      >
        <Fade in={open}>
          ...
          <h2 id="transition-modal-title">User Bio</h2>
          {userBio && userBio}
          </div>
        ...
        <div className={classes.root}>
          ...
          {getFeatureArtWork.length >= 1 ? (
            <section id="Work">
              <Grid className={styles.artWorkContainer}>
                <div>
                  <h1 className={styles.heading1_black}>
                    Featured Art Works
                  </h1>
                </div>
                {getFeatureArtWork &&
                  getFeatureArtWork.map((data, index) => (
                    <Grid
                      container
                      className={styles.featureArtWorkContainer}
                    >
                      ...
                      <div className={classes.sliderimg}>
                        <div className={styles.cardCon}>
                          ...
                          <div className={styles.artContentArea}>
                            ...
                            <Typography
                              className={classes.descriptionParaArt}
                            >
                  ...
                  <Grid container>
                    <Grid item md={6}>
                      <p className={classes.courseTitle}>
                        ...
                        {data.link ? (
                          <>
                            <a href={data.link} target="_blank" className={classes.awrdLink}>
                              <img src={LinkIMG} alt="..." />
                            </a>
                          </>
                        ) : null}
