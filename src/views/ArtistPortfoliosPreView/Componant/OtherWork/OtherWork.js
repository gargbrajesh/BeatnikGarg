    ...
    .then((responseJson) => {
        ...
        if (responseJson.valid == false) {
          alert(responseJson.result.message);
            ...
            var y = JSON.parse(responseJson.result.data[0].otherWork);
            setAnswer(y);
        ...
        <section id="otherwork">
            ...
            <div className={styles.float_container}>
                <Paper elevation={2} className={styles.paper_cover}>
                    <h3 className="mx-5">{answer.title}</h3>
                    <div className="overflow-auto mx-5 mt-4" style={{ height: 'auto' }}>
                        ...
                        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s...bk,
                    </div>
                    <div className={styles.float_container}>
