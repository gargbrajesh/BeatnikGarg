    ...
    fetch("https://app.whyuru.com/api/beatnik_portfolio_artist_show", requestOptions)
      ...
      .then((responseJson) => {
        ...
        if (responseJson.valid == false) {
          ...
          var featured_art_work = JSON.parse(responseJson.result.data[0].featured_art_work);
          ...
          var profile_media_two = JSON.parse(responseJson.result.data[0].profile_media_two);
                ...
                <Grid md={6}>
                  <div className={styles.artWorkContentCon}>
                    <div className={styles.artWorkContent}>
                      <Typography className={styles.typo1}>{data.title}</Typography>
                      <Typography className={styles.typo2}> {data.event},{data.venue}, {data.year}</Typography>

                      <Typography className={styles.typo2}>Art Form :  {data.artForm}</Typography>
                      <Typography className={styles.typo2}>Collborator :  {data.collaborators}</Typography>

                      <Typography className={styles.typo3}>
                        {data.description}
                      </Typography>
                      <div className="d-flex justify-content-center mt-2"><div className='text-aligin-center'><img src={Logo_img} alt='..' /></div></div>
          ...
          <Grid className={styles.cardArtContainer} container spacing={3}>
            ...
            <Grid item md={4}>
              ...
              <div className={styles.cardCon}>
                <div className={styles.cardBackImg} style={{ backgroundImage: `url(${Girl_Pic})`,backgroundRepeat: 'no-repeat' }} />
                <div className={styles.artContentArea}>
                  <p ><img src={Logo_img} alt=''/></p>
                  <Typography className={styles.typo1}>Lorem Ipsum is simply dummy text </Typography>
            ...
            <Grid item md={4}>
              ...
              <div className={styles.cardCon}>
                <div className={styles.cardBackImg} style={{ backgroundImage: `url(${Girl_dance})`, backgroundRepeat: 'no-repeat' }}></div>
                <div className={styles.artContentArea}>
                  <p ><img src={Logo_img} alt='' /></p>
                  <Typography className={styles.typo1}>Lorem Ipsum is simply dummy text </Typography>
                  <Typography className={styles.typo2}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</Typography>
            ...
            <Grid item md={4}>
              ...
              <div className={styles.cardCon}>
                <div className={styles.cardBackImg} style={{ backgroundImage: `url(${Girl_Pic})`,backgroundRepeat: 'no-repeat' }}></div>
