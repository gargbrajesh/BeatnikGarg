    ...
    fetch(
      ...
      .then((responseJson) => {
        ...
        if (responseJson.valid == false) {
          ...
          var trainingData = JSON.parse(responseJson.result.data.training);
  ...
  return (
    <section className={styles.artWork_cover} id="Training">
      <div className="container">
        ...
        >
          <div className="col-6">
            <p className={styles.typo1}>Diploma in Movement Arts</p>
          </div>
          <div className="col-6">
          ...
          <div className="row">
            {" "}
            <p className={styles.para1}>Attakkalari Centre for Movement arts</p>
          </div>
          <div className="row">
            {" "}
            <p className={styles.para1}>Bangalore</p>
          </div>
        </div>
      </div>
    </section>
